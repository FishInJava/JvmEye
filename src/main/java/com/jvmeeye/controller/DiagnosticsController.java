...
public class DiagnosticsController {
    ...
    public ThreadDumpService.ThreadDump threadDump() {
        return threadDumpService.dump();
    }
    ...
    public HeapHistogramService.Histogram histogram(@RequestParam(required = false) Integer top) {
        return heapHistogramService.histogram(top);
    }
}
